...
const int blueSig = 1; //blue ball signature number
const int greenSig = 2; //green ball signature number
const int otherSig = 3; //other color ball signature number

boolean stationary = false; //keep track of stationary/moving status
